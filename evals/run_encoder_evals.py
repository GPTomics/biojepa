#!/usr/bin/env python
'''Run encoder training evaluation suite.'''
import argparse
import os
from pathlib import Path
from .evals import EvalContext, run_encoder_evals, save_report


def main():
    parser = argparse.ArgumentParser(description='Run encoder training evaluation suite')
