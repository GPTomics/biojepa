...
| - | - | - | - | - | - |
| 0.2 | Global MSE: 0.7904 Top-20<br /> Pearson R: 0.5544 | Gears [K562](https://maayanlab.cloud/Harmonizome/dataset/Replogle+et+al.%2C+Cell%2C+2022+K562+Essential+Perturb-seq+Gene+Perturbation+Signatures)<br />10 Epochs | n_embd = 8<br/>n_pathways = 1024<br/>n_heads = 2<br/>n_layers = 2 | Gears 'replogle_k562_essential'<br />BATCH_SIZE = 256<br />10 epochs<br />20000 genes/file | n_embd = 8<br/>n_pathways = 1024<br/><br />LR=1e-2 |
