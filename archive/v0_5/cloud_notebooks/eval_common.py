...
def get_paths(data_root='/home/ubuntu', checkpoint_root='/home/ubuntu'):
...
def load_biojepa_model(paths, device, config=None):
    ...
    checkpoint_path = paths['checkpoint_dir'] / 'bio_jepa_ckpt_63539_final.pt'
...
def load_decoder(paths, device, config=None):
    ...
    decoder_checkpoint_path = paths['checkpoint_dir'] / 'linear_decoder_ckpt_63539_final.pt'
